...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/BenjaminDoran/TreePlots.jl
   ```
...
- After that runs, the [stable docs](https://BenjaminDoran.github.io/TreePlots.jl/stable) should be updated. Check them and look for the version number.
